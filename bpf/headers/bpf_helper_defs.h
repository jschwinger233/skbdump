 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_probe_read)(void *dst,
    __u32 size,
 ...
 * 	in case of failure.
 */
static long (*bpf_trace_printk)(const char *fmt,
    __u32 fmt_size,
    ...)
    = (void *)6;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_store_bytes)(struct __sk_buff *skb,
    __u32 offset,
    const void *from,
    __u32 len,
    __u64 flags)
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_l3_csum_replace)(struct __sk_buff *skb,
    __u32 offset,
    __u64 from,
    __u64 to,
    __u64 size)
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_l4_csum_replace)(struct __sk_buff *skb,
    __u32 offset,
    __u64 from,
    __u64 to,
    __u64 flags)
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_tail_call)(void *ctx,
    void *prog_array_map,
    __u32 index)
    = (void *)12;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_clone_redirect)(struct __sk_buff *skb,
    __u32 ifindex,
    __u64 flags)
    = (void *)13;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_perf_event_output)(void *ctx,
    void *map,
    __u64 flags,
    void *data,
    __u64 size)
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_load_bytes)(const void *skb,
    __u32 offset,
    void *to,
    __u32 len)
    = (void *)26;
 ...
 * 	failure.
 */
static __s64 (*bpf_csum_diff)(__be32 *from,
    __u32 from_size,
    __be32 *to,
    __u32 to_size,
    __wsum seed)
 ...
 */
static long (*bpf_skb_get_tunnel_opt)(struct __sk_buff *skb,
    void *opt,
    __u32 size)
    = (void *)29;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_set_tunnel_opt)(struct __sk_buff *skb,
    void *opt,
    __u32 size)
    = (void *)30;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_change_proto)(struct __sk_buff *skb,
    __be16 proto,
    __u64 flags)
    = (void *)31;
 ...
 */
static long (*bpf_skb_under_cgroup)(struct __sk_buff *skb,
    void *map,
    __u32 index)
    = (void *)33;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_change_tail)(struct __sk_buff *skb,
    __u32 len,
    __u64 flags)
    = (void *)38;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_change_head)(struct __sk_buff *skb,
    __u32 len,
    __u64 flags)
    = (void *)43;
 ...
 * 	value.
 */
static long (*bpf_probe_read_str)(void *dst,
    __u32 size,
    const void *unsafe_ptr)
    = (void *)45;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_setsockopt)(void *bpf_socket,
    int level,
    int optname,
    void *optval,
    int optlen)
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_getsockopt)(void *bpf_socket,
    int level,
    int optname,
    void *optval,
    int optlen)
 ...
 */
static long (*bpf_get_stack)(void *ctx,
    void *buf,
    __u32 size,
    __u64 flags)
    = (void *)67;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_load_bytes_relative)(const void *skb,
    __u32 offset,
    void *to,
    __u32 len,
    __u32 start_header)
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_map_push_elem)(void *map,
    const void *value,
    __u64 flags)
    = (void *)87;
 ...
 * 	0
 */
static long (*bpf_rc_pointer_rel)(void *ctx,
    __s32 rel_x,
    __s32 rel_y)
    = (void *)92;
 ...
 * 	error otherwise.
 */
static long (*bpf_tcp_check_syncookie)(void *sk,
    void *iph,
    __u32 iph_len,
    struct tcphdr *th,
    __u32 th_len)
 ...
 */
static void *(*bpf_sk_storage_get)(void *map,
    void *sk,
    void *value,
    __u64 flags)
    = (void *)107;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_output)(void *ctx,
    void *map,
    __u64 flags,
    void *data,
    __u64 size)
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_xdp_output)(void *ctx,
    void *map,
    __u64 flags,
    void *data,
    __u64 size)
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_copy_from_user)(void *dst,
    __u32 size,
    const void *user_ptr)
    = (void *)148;
 ...
 */
static long (*bpf_snprintf_btf)(char *str,
    __u32 str_size,
    struct btf_ptr *ptr,
    __u32 btf_ptr_size,
    __u64 flags)
 ...
 */
static long (*bpf_ima_inode_hash)(struct inode *inode,
    void *dst,
    __u32 size)
    = (void *)161;
 ...
 */
static long (*bpf_check_mtu)(void *ctx,
    __u32 ifindex,
    __u32 *mtu_len,
    __s32 len_diff,
    __u64 flags)
 ...
 */
static long (*bpf_snprintf)(char *str,
    __u32 str_size,
    const char *fmt,
    __u64 *data,
    __u32 data_len)
 ...
 * 	A syscall result.
 */
static long (*bpf_sys_bpf)(__u32 cmd,
    void *attr,
    __u32 attr_size)
    = (void *)166;
 ...
 */
static long (*bpf_timer_init)(struct bpf_timer *timer,
    void *map,
    __u64 flags)
    = (void *)169;
 ...
 */
static long (*bpf_timer_start)(struct bpf_timer *timer,
    __u64 nsecs,
    __u64 flags)
    = (void *)171;
